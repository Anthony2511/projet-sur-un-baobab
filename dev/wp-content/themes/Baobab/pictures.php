        ...
        <main class="container">
            <div class="fil-ariane">
                <p class="fil-ariane__chemin">
                    <a href="index.html" class="fil-ariane__link">Accueil</a> > <a href="projets.html" class="fil-ariane__link">Projets</a> > <a href="movie.html" class="fil-ariane__link">Safidn'i Pela</a> > <a href="pictures.html" class="fil-ariane__link">Images</a>
                </p>
            </div>
            <div class="pictures">
                <h2 aria-level="2" class="pictures__title">Photos</h2>
                <div class="pictures__container">
                    <div class="pictures__bloc">
                        <img src="img/photo-one.jpg" class="pictures__bloc__image" alt="Décor du tournage" width="300" height="202"/>
                        <p class="pictures__bloc__text">
                            Décor du tournage
                        </p>
                    </div>
                    <div class="pictures__bloc">
                        <img src="img/photo-three.jpg" class="pictures__bloc__image" alt="Enregistrement audio" width="300" height="200"/>
                        <p class="pictures__bloc__text">
                            Enregistrement audio
                        </p>
                    </div>
                    <div class="pictures__bloc">
                        <img src="img/photo-two.jpg" class="pictures__bloc__image" alt="Personnage du court-métrage" width="300" height="200"/>
                        <p class="pictures__bloc__text">
                            Maquettes personnages
                        </p>
                    </div>
                    <div class="pictures__bloc">
                        <img src="img/photo-two.jpg" class="pictures__bloc__image" alt="Personnage du court-métrage" width="300" height="200"/>
