( function() {
    ...
    fTabLinkIsClicked = function( oEvent ) {
        ...
        for ( i = 0 ; i < $tabPanes.length ; i++ ) {
            if ( $tabPanes[ i ].className.indexOf( "active" ) > -1 ) {
                $tabPanes[ i ].className = ".movie__section";
            }
        }
        ...
        document.getElementById( sTargetPaneID ).className = ".movie__section--active";
    ...
    fPageIsLoaded = function() {
        ...
        // tab panes
        $tabLinks = document.querySelectorAll( ".movie__metrage ul li a" );
        $tabPanes = document.querySelectorAll( ".movie__section" );
